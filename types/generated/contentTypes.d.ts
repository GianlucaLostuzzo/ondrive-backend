...
export interface ApiWorkshopWorkshop extends Schema.CollectionType {
  ...
  attributes: {
    address: Attribute.Component<'common.address'>;
    company_data: Attribute.Component<'common.enterprise-data'>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    opening_days: Attribute.Component<'common.work-time', true>;
    publishedAt: Attribute.DateTime;
    services: Attribute.Component<'common.services', true>;
